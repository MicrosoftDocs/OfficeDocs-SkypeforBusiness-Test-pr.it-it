---
title: Attributi dello schema in base alla classe in Lync Server 2013
TOCTitle: Attributi dello schema in base alla classe in Lync Server 2013
ms:assetid: 72726b43-f1ea-458c-9304-a26e8a12128c
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Gg398544(v=OCS.15)
ms:contentKeyID: 49300957
ms.date: 08/24/2015
mtps_version: v=OCS.15
ms.translationtype: HT
---

# Attributi dello schema in base alla classe in Lync Server 2013

 

_**Ultima modifica dell'argomento:** 2015-03-09_

In questa sezione sono elencati gli attributi dello schema che possono essere contenuti in ogni classe di Lync Server 2013 e le classi che possono essere contenute in altre classi. Per un elenco di tutte le classi con le relative descrizioni, vedere [Classi e descrizioni di schemi in Lync Server 2013](lync-server-2013-schema-classes-and-descriptions.md). Per un elenco di tutti gli attributi con le relative descrizioni, vedere [Attributi e descrizioni di schema in Lync Server 2013](lync-server-2013-schema-attributes-and-descriptions.md).
...
<tr class="header">
<th>Classe</th>
<th>Può contenere questi attributi</th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
## Classi contenute in altre classi
...
<tr class="header">
<th>Classe</th>
<th>Può contenere questa classe</th>
</tr>
</thead>
<tbody>
<tr class="odd">
