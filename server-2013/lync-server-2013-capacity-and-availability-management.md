...
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dn720325(v=OCS.15)
ms:contentKeyID: 62222526
ms.date: 08/24/2015
...
Capacity and availability measurements are repetitive tasks that are ideally suited to automated tools and scripts such as Microsoft System Center Operations Manager (in precedenza Microsoft Operations Manager), which is discussed later in this document.
