...
È possibile impostare il criterio client in modo da abilitare l'impostazione **Mostra un'immagine da un sito Web** eseguendo il criterio [Set-CsClientPolicy](set-csclientpolicy.md) in Lync Server Management Shell. I cmdlet di esempio seguenti illustrano come impostare il criterio in modo globale per tutti gli utenti nella distribuzione:
