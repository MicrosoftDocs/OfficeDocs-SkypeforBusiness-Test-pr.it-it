...
Di seguito sono elencate le decisioni da considerare:
  ...
  - **Accesso alle funzionalità di mobilità per tutti gli utenti o selezione degli utenti con accesso a queste funzionalità**
    ...
    Per una descrizione delle impostazioni criteri configurabili e della gestione dei criteri, vedere [New-CsMobilityPolicy](new-csmobilitypolicy.md), [Set-CsMobilityPolicy](set-csmobilitypolicy.md), [Get-CsMobilityPolicy](get-csmobilitypolicy.md), [Grant-CsMobilityPolicy](grant-csmobilitypolicy.md) e [Remove-CsMobilityPolicy](remove-csmobilitypolicy.md).
