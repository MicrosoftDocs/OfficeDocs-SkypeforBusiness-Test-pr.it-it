---
title: Tabella UserAgentDef (QoE) in Lync Server 2013
TOCTitle: Tabella UserAgentDef (QoE) in Lync Server 2013
ms:assetid: cfd8e3e0-4076-4162-9381-5276da8316d9
ms:mtpsurl: https://technet.microsoft.com/it-it/library/JJ205259(v=OCS.15)
ms:contentKeyID: 49302033
ms.date: 08/24/2015
mtps_version: v=OCS.15
ms.translationtype: HT
---

# Tabella UserAgentDef (QoE) in Lync Server 2013

 

_**Ultima modifica dell'argomento:** 2015-03-09_

Nella tabella UserAgentDef viene eseguito il mapping tra gli identificatori degli agenti utente e i nomi descrittivi degli agenti. Gli agenti utente sono client software utilizzati per la connessione a Microsoft Lync Server 2013.
