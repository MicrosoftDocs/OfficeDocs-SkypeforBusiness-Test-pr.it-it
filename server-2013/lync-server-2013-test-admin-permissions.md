...
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dn767945(v=OCS.15)
ms:contentKeyID: 62486258
ms.date: 08/24/2015
...
For more information on OU permissions, see the article [Ereditarietà delle autorizzazioni disabilitata nei contenitori di oggetti Computer, User o InetOrgPerson in Lync Server 2013](lync-server-2013-permissions-inheritance-is-disabled-on-computers-users-or-inetorgperson-containers.md).
