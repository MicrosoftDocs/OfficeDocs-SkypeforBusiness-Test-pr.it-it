---
title: "Lync Server 2013: Porte: topol. perim. consolid. c/ scalab. implem., bilanciam. carico DNS con indir. IP privati via NAT"
TOCTitle: Riepilogo delle porte - topologia perimetrale consolidata con scalabilità implementata, bilanciamento del carico DNS con indirizzi IP privati tramite NAT
ms:assetid: a296c2af-54d4-4b4f-9795-9191baf688cb
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Gg412756(v=OCS.15)
ms:contentKeyID: 49301519
ms.date: 08/24/2015
mtps_version: v=OCS.15
ms.translationtype: HT
---

# Riepilogo delle porte - topologia perimetrale consolidata con scalabilità implementata, bilanciamento del carico DNS con indirizzi IP privati tramite NAT in Lync Server 2013
...
**Rete perimetrale aziendale per server perimetrale consolidato in scala con indirizzi IP privati che utilizzano NAT**
...
### Riepilogo firewall per topologia perimetrale consolidata con scalabilità implementata con bilanciamento del carico DNS e indirizzi IP privati con NAT: interfaccia esterna - Nodo 1 e nodo 2 (esempio)
...
<td><p>Qualsiasi</p></td>
<td><p>servizio Web Conferencing Edge del server perimetrale</p></td>
...
### Riepilogo firewall per topologia perimetrale consolidata con scalabilità implementata con bilanciamento del carico DNS e indirizzi IP privati con NAT: interfaccia interna - Nodo 1 e nodo 2 (esempio)
...
<td><p>XMPP/MTLS/TCP/23456</p></td>
<td><p>Qualsiasi</p></td>
<td><p>Indirizzo IP dell'interfaccia di ogni server perimetrale interno</p></td>
