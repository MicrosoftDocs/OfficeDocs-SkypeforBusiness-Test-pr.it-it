---
title: Indice dei cmdlet di Lync Server 2013
TOCTitle: Indice dei cmdlet di Lync Server 2013
ms:assetid: cd37aba7-3d27-4db9-b69f-3a6da1fb4b4a
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Gg398867(v=OCS.15)
ms:contentKeyID: 49302013
ms.date: 08/24/2015
mtps_version: v=OCS.15
ms.translationtype: HT
---

# Indice dei cmdlet di Lync Server 2013

 

_**Ultima modifica dell'argomento:** 2014-03-19_

Microsoft Lync Server 2013 include più di 700 cmdlet che consentono agli amministratori di gestire Lync Server 2013 dalla riga di comando. I cmdlet di Lync Server vengono usati in genere con Lync Server Management Shell. Un modo per usare Lync Server Management Shell consiste nell'accedere a un computer in cui è in esecuzione un servizio o un ruolo del server di Lync Server, fare clic sul pulsante **Start**, scegliere **Tutti i programmi**, **Microsoft Lync Server 2013** e quindi **Lync Server Management Shell**. Dopo aver aperto Management Shell, è possibile recuperare le informazioni della Guida per un cmdlet direttamente dalla riga di comando digitando un comando simile al seguente:
...
Per recuperare l'elenco completo dei cmdlet disponibili per la gestione di Lync Server, digitare quanto segue al prompt dei comandi di Lync Server Management Shell:

    Get-Command * -Module Lync -CommandType cmdlet

Per informazioni dettagliate sull'utilizzo di Lync Server Management Shell, vedere il blog relativo a Lync Server Windows PowerShell all'indirizzo [http://go.microsoft.com/fwlink/?linkid=203150\&clcid=0x410](http://go.microsoft.com/fwlink/?linkid=203150%26clcid=0x410).

## Lync Server 2013 Cmdlet

Di seguito è riportato l'elenco dei cmdlet inclusi in Lync Server 2013:
